		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commoonygestorinventario-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commoonygestorinventario-display": {
								"semanticObject": "commoonygestorinventario",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.moony.gestorinventario",
									"url": sap.ui.require.toUrl("com/moony/gestorinventario")
								}
							}
						}
					}
